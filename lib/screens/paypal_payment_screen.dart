...
import '../controllers/paypal_payment_controller.dart';
...
class PaypalPaymentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final PaypalPaymentController controller =
        Get.put(PaypalPaymentController());
          ...
          color: Color(0xFF003087),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: controller.addPaypalAccount,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFFF5A623), // PayPal Orange Theme
                    elevation: 0,
  ...
  Widget _buildPaymentTab(
    String title,
    int index,
    PaypalPaymentController controller,
    Color primaryColor,
  ) {
