...
class _EarningsScreenState extends State<EarningsScreen> {
  ...
  Widget build(BuildContext context) {
    ResponsiveEarnings.isSmallScreen(context);
    final padding = ResponsiveEarnings.padding(context);
    final spacing = ResponsiveEarnings.spacing(context, 20.0);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: ResponsiveEarnings.spacing(context, 16.0)),
          ],
        ),
      ),
    );
  ...
  AppBar _buildAppBar(BuildContext context) {
    final isSmall = ResponsiveEarnings.isSmallScreen(context);
    final iconSize = ResponsiveEarnings.fontSize(context, 20.0);
    ...
    return AppBar(
      ...
      title: Text(
        'Earnings',
        style: TextStyle(
          fontSize: ResponsiveEarnings.fontSize(context, isSmall ? 16.0 : 20.0),
  ...
  Widget _buildTimePeriodTabs(BuildContext context) {
    final isSmall = ResponsiveEarnings.isSmallScreen(context);
    ResponsiveEarnings.fontSize(context, 13.0);
            ...
            child: GestureDetector(
              ...
              child: Container(
                padding: EdgeInsets.symmetric(
                  vertical: ResponsiveEarnings.spacing(
                    context,
                    isSmall ? 8.0 : 10.0,
                  ),
                ),
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: ResponsiveEarnings.fontSize(
                        context,
                        isSmall ? 11.0 : 13.0,
                      ),
  ...
  Widget _buildTotalExpensesCard(BuildContext context) {
    final isSmall = ResponsiveEarnings.isSmallScreen(context);
    ResponsiveEarnings.fontSize(context, 34.0);

    return Container(
      padding: EdgeInsets.all(
        isSmall ? 16.0 : ResponsiveEarnings.spacing(context, 20.0),
      ),
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: ResponsiveEarnings.spacing(context, 8.0)),
          Row(
            children: [
              Text(
                '\$2,540.00',
              ...
              SizedBox(width: ResponsiveEarnings.spacing(context, 12.0)),
              Container(
                ...
                child: Row(
                  children: [
                    Icon(
                      Icons.arrow_upward,
                      size: ResponsiveEarnings.fontSize(
                        context,
                        isSmall ? 12.0 : 14.0,
                      ),
                      color: Colors.white,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: ResponsiveEarnings.spacing(context, 20.0)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: ResponsiveEarnings.spacing(context, 12.0)),
  ...
  Widget _buildTransactionItem(
    ...
    final isSmall = ResponsiveEarnings.isSmallScreen(context);
    ResponsiveEarnings.fontSize(context, 14.0);

    return Container(
      padding: EdgeInsets.symmetric(
        vertical: ResponsiveEarnings.spacing(context, 12.0),
      ),
      decoration: BoxDecoration(
        border: Border(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(
              ...
              color: color,
              size: ResponsiveEarnings.fontSize(context, isSmall ? 16.0 : 20.0),
            ),
          ),
          SizedBox(width: ResponsiveEarnings.spacing(context, 12.0)),
  ...
  String _getShortTitle(String title) {
    if (title == 'Sea Side Villa') return 'Sea Villa';
    if (title == 'Downtown Apartment') return 'Downtown Apt';
    return title;
  }

  Widget _buildExportButton(BuildContext context) {
    final isSmall = ResponsiveEarnings.isSmallScreen(context);
    ResponsiveEarnings.fontSize(context, 16.0);
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        icon: Icon(
          ...
          size: ResponsiveEarnings.fontSize(context, 20.0),
        ),
        label: Text(
